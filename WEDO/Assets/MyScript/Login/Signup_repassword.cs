...
public class Signup_repassword : MonoBehaviour
{
    ...
    public static string signupRePassword = "";
    ...
    private void checkContent()
    {
        ...
        signupRePassword = Keyboard.curSentence;
    ...
    private void checkFocus()
    {
        ...
        else if (RayHit.LeftHitName.Equals(name) || RayHit.RightHitName.Equals(name))
        {
            if (LeftHandProperty.isClosed && !LeftHandProperty.clickUsed)
            {
                ...
                Keyboard.curSentence = signupRePassword;
            }
    ...
    {
        string showPassword = "";
        for (int i = 0; i < signupRePassword.Length; i++)
        {
            showPassword += "*";
        }
        return showPassword;
