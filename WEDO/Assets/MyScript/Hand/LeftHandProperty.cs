...
public class LeftHandProperty : MonoBehaviour
{

    public static bool isClosed = false;
    public static bool clickUsed = true;   //每次手势闭合只能被用一次 
    public static string HANDNAME = "LeftHand";
    ...
    public string handOpenMaterialName = "BlackLeftHand";
    public Material handCloseMaterial;
    public string handCloseMaterialName = "BlackLeftHandFist";
