...
namespace Wedo_ClientSide
{
    class RoomInterface
    {
        ...
        private RoomInterface(Guid projectGuid, Guid nowUserGuid, dynamic infos)
        {
        ...
        private bool UpdateInfo(dynamic infos)
        {
            try
            {
        ...
        static public RoomInterface CreateRoom(string guid, string projectGuid)
        {
            ...
            dynamic x = JObject.Parse(Connect.ReceiveMessage());
